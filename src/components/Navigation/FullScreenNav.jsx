    ...
    <div id="fullscreennav" className="text-white h-screen overflow-x-hidden py-60 w-full absolute bg-black">
      ...
      <div className="">
        ...
        <div className=" link relative border-t-1 border-white">
          <h1 className="font-[font-2] text-[8vw] text-center leading-[1] pt-8 uppercase">Projects</h1>
          <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
            <div className=" moveX flex  item-center">
            <h2 className=" whitespace-nowrap font-[font-2] text-[8vw] text-center leading-[0.8] pt-9 uppercase">Pour Tout voir</h2>
